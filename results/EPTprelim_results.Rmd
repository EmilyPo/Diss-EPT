...
s01 <- readRDS(here("sims", "may", "simBase0.rds"))
s02 <- readRDS(here("sims", "may", "simAvg0.rds"))
s03 <- readRDS(here("sims", "may", "simNc0.rds"))

s1 <- readRDS(here("sims", "may", "simBase.rds"))
s2 <- readRDS(here("sims", "may", "simAvg.rds"))
s3 <- readRDS(here("sims", "may", "simNc.rds"))

s1ept <- readRDS(here("sims", "may", "simBaseEPT.rds"))
s2ept <- readRDS(here("sims", "may", "simAvgEPT.rds"))
s3ept <- readRDS(here("sims", "may", "simNcEPT.rds"))

s1epthigh <- readRDS(here("sims", "may", "simBaseEPThigh.rds"))
s2epthigh <- readRDS(here("sims", "may", "simAvgEPThigh.rds"))
s3epthigh <- readRDS(here("sims", "may", "simNcEPThigh.rds"))

s1ept100 <- readRDS(here("sims", "may", "simBaseEPT100.rds"))
s2ept100 <- readRDS(here("sims", "may", "simAvgEPT100.rds"))
s3ept100 <- readRDS(here("sims", "may", "simNcEPT100.rds"))
```
